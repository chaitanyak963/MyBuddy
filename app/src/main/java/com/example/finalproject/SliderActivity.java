...
public class SliderActivity extends AppCompatActivity {
    ...
    String strPermission = Manifest.permission.READ_EXTERNAL_STORAGE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SliderActivity.this, AuthenticationActivity.class));
                finish();
            }
        });
        ...
        String Permissons[] = {mPermission, sPermission, tPermission,strPermission,stPermission};
